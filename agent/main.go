...
func setupflags() {
	...
	flag.StringVar(&metricsbindaddress, "metricsbindaddress", "0", "metricsbindaddress is the TCP address that the controller should bind to for serving prometheus metrics.It can be set to \"0\" to disable the metrics serving")
	...
	flag.BoolVar(&printVersion, "version", true, "Print the version of the agent")
